    ...
    <div className="flex flex-col h-full">
      <div className="flex-1">
        <div className={styles.quickConnect}>
          <div className={styles.quickConnectContent}>
            <div className={styles.quickConnectInner}>
              <article className={styles.quickConnectHeader}>
                <h1 className="gradient-text">{`Let's work together`}</h1>
                <p className="description">{`Let's make magic together!`}</p>
              </article>
              <div className={styles.quickConnectButtons}>
                <a
                ...
                <button
                  className={`${styles.connectButton} ${styles.connectButtonSecondary}`}
                  type="button"
